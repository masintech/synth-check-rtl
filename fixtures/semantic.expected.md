...
| 6  | semantic.sv:56 | `mixed logic in sequential block`  | warning  | synthesis-correctness |
...
| 10 | semantic.sv:80 | `generate misuse`                   | note     | structural/port      |
| 11 | semantic.sv:88 | `port width mismatch`              | warning  | structural/port      |
